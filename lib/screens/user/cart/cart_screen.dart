...
import 'package:omani_agriculture_app/screens/user/checkout/checkout_screen.dart';
                          ...
                          child: ElevatedButton(
                              onPressed: (){
                                Navigator.pushReplacement(
                                  context,
                                  PageRouteBuilder(
                                    pageBuilder: (c, a1, a2) => AppBottomNavBarCustomerScreen(index: 0, title: 'Users', subTitle: '',),
                                    transitionsBuilder: (c, anim, a2, child) => FadeTransition(opacity: anim, child: child),
                                    transitionDuration: Duration(milliseconds: 100),
                                  ),
                                );
                                                                  ...
                                                                  FirebaseFirestore
                                                                      ...
                                                                      .whenComplete(
                                                                        ...
                                                                        ScaffoldMessenger.of(context).showSnackBar(
                                                                            const SnackBar(
                                                                                backgroundColor: darkBrownColor,
                                                                                content:  Text('Successfully Removed',style: TextStyle( fontFamily: "Poppins",color: whiteColor),)
                                                                            )
                                                                        );
                                                                      });
                                                                },
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //   height: size.height*0.02,
                    // ),
                    _isLoading ? Center(child: CircularProgressIndicator(color: darkBrownColor,strokeWidth: 0.5,)) :
                    Container(
                      width: size.width*0.85,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
