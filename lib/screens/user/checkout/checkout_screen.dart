...
import 'package:omani_agriculture_app/screens/qr_code_scanner_screen.dart';
import 'package:omani_agriculture_app/screens/user/payment/payment_screen.dart';
                          ...
                          if(_productsListForPost.length == _productsList.length) {
                            ...
                            FirebaseFirestore.instance
                              ...
                              Navigator.pushReplacement(
                                context,
                                PageRouteBuilder(
                                  pageBuilder: (c, a1, a2) => AppBottomNavBarCustomerScreen(index: 0, title: userType, subTitle: '',),
                              ...
                              ScaffoldMessenger.of(context)
                                  ...
                                  content: Text(
                                    ...
                                    style:
                                    TextStyle( fontFamily: "Poppins",color: whiteColor),
                                  )));
                            });
