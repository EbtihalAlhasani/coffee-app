  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Detail',
          style: TextStyle( fontFamily: "Poppins",fontSize: 19, fontWeight: FontWeight.w600,color: Colors.white),
        ),
        centerTitle: true,
      ),
      body:
      ...
      SingleChildScrollView(
        ...
        Center(
          child: Column(children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:Column(
                            ...
                            Text(
                              name.toString(),
                              style: TextStyle( fontFamily: "Poppins",fontSize: 20, fontWeight: FontWeight.w500,color: Colors.black),
                            ),
                              SizedBox(
                                height: 8,
                              ),
                              Text(
                                email.toString(),
                                style: TextStyle( fontFamily: "Poppins",fontSize: body12_16, fontWeight: FontWeight.bold,color: primaryColor),
                              ),
                            ...
                            SizedBox(
                              ...
                              Text(
                                phone.toString(),
                                style: TextStyle( fontFamily: "Poppins",fontSize: body12_16, fontWeight: FontWeight.bold,color: Colors.black),
                              ),
            ...
            //         child: Text(
            //         'Student Name',
            //           style: TextStyle( fontFamily: "Poppins",fontSize: body12_16, fontWeight: FontWeight.w500,color: Colors.grey),
            //         ),
            //       ),
            //       Padding(
            ...
            //         child: Text(
            //          name.toString(),
            //           style: TextStyle( fontFamily: "Poppins",fontSize: body12_16, fontWeight: FontWeight.w400,color: Colors.black),
            //         ),
            //       ),
            //     ],
            //   ),
            ...
            //         child: Text(
            //           email.toString(),
            //           style: TextStyle( fontFamily: "Poppins",fontSize: 12, fontWeight: FontWeight.w400,color: Colors.black),
            //         ),
            //       ),
            //     ],
            //   ),
