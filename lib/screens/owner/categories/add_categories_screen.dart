                      ...
                      if(widget.status == 'update') {
                        ...
                        FirebaseFirestore.instance
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              const  SnackBar(
                                  backgroundColor: darkBrownColor,
                                  content:  Text('Category updated successfully',style: TextStyle( fontFamily: "Poppins",color: whiteColor),)
                              )
                          );
                        });
                        ...
                        if (isClassNameExist == 'yes') {
                          ...
                          FirebaseFirestore.instance
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                                const  SnackBar(
                                    backgroundColor: darkBrownColor,
                                    content:  Text('Category Added Successfully',style: TextStyle( fontFamily: "Poppins",color: whiteColor),)
                                )
                            );
