              ...
              child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle( fontFamily: "Poppins",color: greyColor),
                    ),
                  ...
                  child: Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(color: darkBrownColor,width: 1)
                      ),
                      child: Padding(
                        padding: const EdgeInsets.all(10.0),
                        child: const Text(
                          'Upload Product Image',
                          style: TextStyle( fontFamily: "Poppins",color: darkBrownColor),
                        ),
                      ),
                    ),
                  ),
                      ...
                      if(widget.status == 'update') {
                        ...
                        FirebaseFirestore.instance
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              const  SnackBar(
                                  backgroundColor: darkBrownColor,
                                  content:  Text('Product updated successfully',style: TextStyle( fontFamily: "Poppins",color: whiteColor),)
                              )
                          );
                        });
                        ...
                        if (isClassNameExist == 'yes') {
                          ...
                          FirebaseFirestore.instance
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                                const  SnackBar(
                                    backgroundColor: darkBrownColor,
                                    content:  Text('Product Added Successfully',style: TextStyle( fontFamily: "Poppins",color: whiteColor),)
                                )
                            );
                          });
                        }
