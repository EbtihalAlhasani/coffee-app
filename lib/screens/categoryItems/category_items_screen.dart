  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.category,style: TextStyle( fontFamily: "Poppins",fontWeight: FontWeight.bold, color: Colors.white),),),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                            child: Text(
                                              ...
                                              style:
                                              TextStyle( fontFamily: "Poppins",color: Colors.black, fontSize: 13,fontWeight: FontWeight.bold),),
                                          ),
                                        ),
                                        // SizedBox(
                                        //   height: size.height*0.01,
                                        ...
                                        //         style: TextStyle( fontFamily: "Poppins",color: Color(0xFF585858), fontSize: 12,fontWeight: FontWeight.w600),),
                                        //
                                        //       GestureDetector(
                                        //         onTap:() {
                                        //
